#' The toolbox for analysing single-cell protein intensity from the LEGENDScreen assay.
#' 
...
#' @param batch_key Data from plate-based experiments (default: batch_key="plate") or not (batch_key="batch")
