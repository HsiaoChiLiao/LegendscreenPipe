...
**COMING SOON**: 
<br>
Experiments (FFC) from different batches...
<br>
...
<br>
Section 1 (S1). Installing `LegendscreenPipe` and downloading the sample dataset
<br>
Section 2 (S2). Analysing the single-cell protein intensities with `LegendscreenPipe`
<br>
